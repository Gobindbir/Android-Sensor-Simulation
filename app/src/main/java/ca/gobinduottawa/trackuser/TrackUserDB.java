...
/**
 * Created by Gobind on 2016-11-01.
 */

public class TrackUserDB extends SQLiteOpenHelper
{
    ...
    SQLiteDatabase db;
    public static final String Tag= TrackUserDB.class.getSimpleName();
    ...
    public TrackUserDB(Context context)
    {
