...
public class Walking extends AppCompatActivity implements OnMapReadyCallback
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView clock = (TextView) findViewById(R.id.textView3);
        clock.setText("You Started Walking at: " + Calendar.getInstance().getTime().toString());
        ...
        final MediaPlayer mp3 = MediaPlayer.create(this, R.raw.song);
        ...
        gt.setOnTouchListener(new OnSwipeTouchListener(Walking.this) {
            ...
            public void onSwipeLeft() {
                startActivity(new Intent(Walking.this, ViewDB.class));
            }
