...
public class Driving extends AppCompatActivity implements OnMapReadyCallback
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView clock=(TextView) findViewById(R.id.textView5);
        clock.setText("You Started Driving at: "+ Calendar.getInstance().getTime().toString());
        ...
        gt.setOnTouchListener(new OnSwipeTouchListener(Driving.this) {
            ...
            public void onSwipeLeft() {
                startActivity(new Intent(Driving.this, ViewDB.class));
            }
